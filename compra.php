    ...
    <div class="container border p-2">
      <div class="row">
        <div class="col-12 col-md-4 mb-2 mb-md-0">
          <label class="form-label text-danger fw-bold" id="lblnumerocompra"><?php echo $numeroVenda; ?></label>
        </div>
      ...
      <div class="row">
        <div class="col-12 col-md-4 mt-2">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" maxlength="80" id="txtfornecedor"
