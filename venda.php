  ...
  <div class="container border p-4 mt-2">
    <div class="row">
      ...
      <div class="col-12 mt-2 text-center">
        <button class="btn btn-success me-2" id="btnadicionar">Adicionar</button>
        <button class="btn btn-danger me-2" id="btnexcluir">Excluir</button>
        <button class="btn btn-warning" id="btnfecharvenda">Fechar Venda</button>
      </div>
    </div>
  </div>
